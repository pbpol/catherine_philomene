...
{else}
	<!-- MODULE Block footer -->
	<section class="footer-block col-lg-2 col-md-2 col-sm-2 col-xs-12 wow fadeInUp " data-wow-delay="400ms" id="block_various_links_footer">
				...
				{if $cmslink.meta_title != ''}
					<li class="item">
						<a href="{$cmslink.link|escape:'html':'UTF-8'}" title="{$cmslink.meta_title|escape:'html':'UTF-8'}">
							...
							{if $cmslink.link == 'https://catherine-philomene.com/content/achat-bijoux-anciens.html'}
							   Achat Bijoux Anciens
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/achat-bijoux-en-or.html'}
							   Achat Bijoux en Or
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/achat-bijoux-en-diamant.html'}
								Achat Bijoux en Diamant
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/achat-collier-en-diamant.html'}
								Achat Collier en Diamant
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/livraison.html'}
							   Livraison
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/mentions-legales.html'}
							   Mentions l&eacute;gales
							{elseif $cmslink.link == 'https://catherine-philomene.com/content/conditions-utilisation.html'}
