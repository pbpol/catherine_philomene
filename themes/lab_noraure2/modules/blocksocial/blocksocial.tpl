...
<section id="social_block" class="footer-block wow fadeInUp " data-wow-delay="700ms">
	<h4>{l s='Connect us' mod='blocksocial'}</h4>
	<div class="block_content toggle-footer">
	<ul>
		{if $facebook_url != ''}
			<li class="facebook">
				<a 	target="_blank" href="{$facebook_url|escape:html:'UTF-8'}"
					title="{l s='Facebook' mod='blocksocial'}" >
		...
		{if $twitter_url != ''}
			<li class="twitter">
				<a 	target="_blank" href="{$twitter_url|escape:html:'UTF-8'}"
					title="{l s='Twitter' mod='blocksocial'}" >
        ...
        {if $youtube_url != ''}
        	<li class="youtube">
				<a 	target="_blank" href="{$youtube_url|escape:html:'UTF-8'}"
					title="{l s='Youtube' mod='blocksocial'}" >
        ...
        {if $google_plus_url != ''}
        	<li class="google-plus">
				<a 	target="_blank" href="{$google_plus_url|escape:html:'UTF-8'}"
					title="{l s='Google Plus' mod='blocksocial'}" >
        ...
        {if $pinterest_url != ''}
        	<li class="pinterest">
				<a 	target="_blank" href="{$google_plus_url|escape:html:'UTF-8'}"
					title="{l s='Pinterest' mod='blocksocial'}" >
