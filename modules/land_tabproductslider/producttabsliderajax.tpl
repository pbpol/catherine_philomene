	...
	$(document).ready(function() {
		...
		jQuery("ul.tabs li").click(function(){
			...
			if(jQuery.trim(checkExist).length == 0 || checkExist == undefined){
				jQuery(".tab_container.lablistproducts .sliderLoadingTab").remove();
				jQuery(".tab_container.lablistproducts").append('<span class="sliderLoadingTab">Loading...</span>');
				...
				jQuery.ajax({
		            ...
		            success:function(data){
		            	...
		            	jQuery(".tab_container.lablistproducts .sliderLoadingTab").remove();
		            	jQuery(".lablistproducts").append(results);
		                return false;
		            }
		        });
	        }
