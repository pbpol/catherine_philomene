...
class MegaTopLinks
{
    ...
    {
        $result = true;
        $result &=Db::getInstance()->delete('linksmegatop', 'id_linksmegatop = '.(int)$id_linksmegatop.' AND id_shop = '.(int)$id_shop);
        $result &=Db::getInstance()->delete('linksmegatop_lang', 'id_linksmegatop = '.(int)$id_linksmegatop);
        return $result ;
    }
