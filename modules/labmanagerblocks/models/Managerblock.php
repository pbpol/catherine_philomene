...
class ManagerBlock extends ObjectModel
{
    ...
    public  function getStaticblockLists($id_shop = NULL, $hook_position= 'top') { 
		...
		');
		    ...
		    $blockModule= null;
		    $urlReplace = _PS_BASE_URL_.$_SERVER['REDIRECT_REWRITEBASE'];
			 ...
			 $blockModule = $this->getModuleAssign($nameModule, $hookModule);
                       ...
                       $ob['block_module'] = $blockModule;
						...
						$description = str_replace('/noraure/img/',$urlReplace."img/",$description);
						$description = str_replace('/lab_noraure/img/',$urlReplace."img/",$description);
