            ...
            {foreach from=$view_data item=post}
                    ...
                    <div class="item-inner">
						<div class="item-i">
							...
							<a href="{smartblog::GetSmartBlogLink('smartblog_post',$options)}" title="{l s='See more' mod='smartbloghomelatestnews'}"  class="r_more">{l s='{...}' mod='smartbloghomelatestnews'}<i class="fa fa-angle-double-right"></i></a>
						</div>
                    </div>
